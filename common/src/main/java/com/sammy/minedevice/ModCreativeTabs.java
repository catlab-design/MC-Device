...
public final class ModCreativeTabs {
    ...
    public static void init() {
        ...
        // เงิน: ธนบัตร (ธนบัตร) → เหรียญ (coin) → ตู้/ธนาคาร (ATM)
    ...
    private static ItemStack dyedMegaphone(DyeColor color) {
        ...
        stack.getOrCreateTagElement("display").putInt("color", dyeColorToRgb(color));
        stack.setHoverName(Component.literal(formatColorName(color) + " Megaphone"));
        return stack;
    }
